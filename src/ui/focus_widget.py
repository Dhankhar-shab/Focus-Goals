...
class FocusWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.mode_selector.addItems(["Pomodoro", "Time Block", "Clock"])
        ...
        # 2. Content Stack (Pomodoro vs Time Block vs Clock UI)
        ...
        self.flip_timer = FlipClockWidget(show_seconds=False, mode="manual")
        ...
        pomo_layout.addWidget(self.flip_timer)
        ...
        clock_layout = QVBoxLayout(self.clock_page)
        clock_layout.setAlignment(Qt.AlignCenter)
        
        self.full_flip_clock = FlipClockWidget(show_seconds=True, mode="auto")
        clock_layout.addWidget(self.full_flip_clock)
    ...
    def update_pomo_ui(self):
        ...
        self.flip_timer.set_time(self.mgr.get_display_time())
